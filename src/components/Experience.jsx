    ...
    <div id="experience" className="pt-32 font-montserrat">
      ...
      <div className="grid md:grid-flow-col mt-10">
        ...
        <div className="grid grid-flow-row gap-7 pb-5 mt-7 md:mt-0 overflow-hidden px-2">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" className="flex gap-4 md:gap-10 py-4 pl-6 pr-3 md:pl-10 md:pr-6 shadow rounded-xl w-full sm:w-max hover:shadow-lg">
